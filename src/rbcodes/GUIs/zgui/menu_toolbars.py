...
from rbcodes.GUIs.zgui.user_manual import UserManualDialog
from rbcodes.GUIs.zgui.utils import FitsObj, Fits_2dAux
from rbcodes.GUIs.zgui.spec_advanced2d import ShowAdvanced, ZGuessPosterior
	...
	def _read_selected_fits(self, i):
		...
		if i < 1:
			...
			if self.mW.xspecio:
				...
				if self.mW.toggle_frames:
					from rbcodes.GUIs.zgui.gui_frame_io import ToggleFrames
