...
def read_line_list(label):
    ...
    if label=='atom':
        filename=resource_filename('rbcodes.igm','lines/atom_full.dat')
    elif label == 'LLS':
        filename=resource_filename('rbcodes.igm','lines/lls.lst')
    elif label == 'LLS Small':
        filename=resource_filename('rbcodes.igm','lines/lls_sub.lst')
    elif label == 'DLA':
        filename=resource_filename('rbcodes.igm','lines/dla.lst')
    elif label == 'LBG':
        filename=resource_filename('rbcodes.igm','lines/lbg.lst')
    elif label == 'Gal':
        filename=resource_filename('rbcodes.igm','lines/gal_vac.lst')
    elif label == 'Eiger_Strong':
        filename=resource_filename('rbcodes.igm','lines/Eiger_Strong.lst')
    elif label == 'Gal_Em':
        filename=resource_filename('rbcodes.igm','lines/Galaxy_emission_Lines.lst')
    elif label == 'Gal_Abs':
        filename=resource_filename('rbcodes.igm','lines/Galaxy_absorption_Lines.lst')
    elif label == 'Gal_long':
        filename=resource_filename('rbcodes.igm','lines/Galaxy_Long_E_n_A.lst')
    elif label == 'AGN':
        filename=resource_filename('rbcodes.igm','lines/AGN.lst')
    elif label == 'HI_recomb':
        filename=resource_filename('rbcodes.igm','lines/HI_recombination.lst')
    elif label == 'HI_recomb_light':
        filename=resource_filename('rbcodes.igm','lines/HI_recombination_light.lst')
