...
class rb_spec(object):
    ...
    -------
        ...
        from rbcodes.gui.rb_spec import rb_spec as r 
        ...
        from rbcodes.gui.rb_spec import load_rb_spec_object as r_load
    ...
    def fit_continuum(self,mask=False,domain=False,Legendre=False,**kwargs):
        ...
        if Legendre==False:
            ...
            if 'prefit_cont' in kwargs:
                ...
                from rbcodes.gui import rb_fit_interactive_continuum as f
    ...
    def vpfit_singlet(self,FWHM=6.5):
        ...
        """
        from rbcodes.gui import rb_interactive_vpfit_singlet as vf 
